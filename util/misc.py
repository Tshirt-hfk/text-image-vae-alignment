...
Adapted from JiT (https://github.com/xxx/JiT) util/misc.py for AlignmentVAE.
"""
...
def init_distributed_mode(args):
    ...
    Supports:
      - OMPI (Open MPI) environment
      - torchrun / torch.distributed.launch (RANK, WORLD_SIZE, LOCAL_RANK)
      - SLURM
      - Single-GPU fallback
    """
    if args.dist_on_itp:
...
def all_reduce_mean(x):
    """Average a scalar across all distributed processes."""
